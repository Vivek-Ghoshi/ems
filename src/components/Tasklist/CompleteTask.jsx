...
const CompleteTask = ({data}) => {
  return (
    <div className='flex-shrink-0 h-full w-72 px-4 py-3 bg-blue-400 rounded-xl'>
    ...
    <div className='flex justify-between mt-2'>
      <button className='w-full bg-green-500 px-2 py-2 text-sm text-white rounded-md'>Completed</button>
    </div>
  </div>
  )
}
